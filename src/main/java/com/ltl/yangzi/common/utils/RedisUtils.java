package com.ltl.yangzi.common.utils;
...
public class RedisUtils {
   ...
   * @param type 时间单位
   */
  public void setForExpireTime(String key, String value, long time, TimeUnit type) {
  ...
  public Long differenceAndStore(String key, Collection<String> otherKeys, String newKey) {
    return redisTemplate.opsForSet().differenceAndStore(key, otherKeys, newKey);
  }
